...
export const metadata: Metadata = {
  title: "Pragati Peharkar - Full Stack Developer",
  description:
    "A self-taught UI/UX designer and Software Engineer. Creating meaningful and delightful digital products that balance user needs and business goals.",
  keywords: [
    "Pragati Peharkar",
    "Software Engineer",
    "Frontend Developer",
  ...
  openGraph: {
    ...
    title: "Pragati Peharkar - Full Stack Developer",
    description:
      "A self-taught UI/UX designer and Software Engineer. Creating meaningful and delightful digital products.",
    siteName: "Pragati Peharkar Devfolio",
  },
  twitter: {
    card: "summary_large_image",
    title: "Pragati Peharkar - Full Stack Developer",
    description:
      "A self-taught UI/UX designer and Software Engineer.",
  },
};
  ...
  return (
    <html lang="en">
      <head>
        <link
          rel="canonical"
          href="https://prari2725.github.io/devfolio/"
        />
      </head>
