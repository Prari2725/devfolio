      ...
      <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Pragati Peharkar</span>
                    </p>
                  </div>
              ...
              <Image
                ...
                alt="Pragati Peharkar - A Full Stack Developer"
                width={300}
                height={300}
                className="max-w-md "
                style={{ width: "auto", height: "auto" }}
        ...
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Currently seeking Software Engineer / Full-Stack Developer opportunities
</span>
            
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            A Full Stack Developer with expertise in Java and React, delivering clean, scalable, and impactful digital products that bridge user experience and business value.
          </p>
        </div>
      </div>
    </section>
